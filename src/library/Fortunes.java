...
public class Fortunes {
	...
	public static final String[] EASTER_EGG_FORTUNES = new String[] {
			"You realize all I am is a pseudo-random number generator picking a list of arbitrary strings from a list of pre-written fortunes ripped directly from chinese motivational quotes websites, right?",
			"Your fortune is-- wait, sorry, I ate the paper with the cookie. Try again?",
			"What do you get when you cross a fortune cookie with an easter egg? No, seriously. Is it a fortune egg? An easter cookie?",
			"Here's your easter egg answer!! Is this what you wanted??!! Are you happy now?? Can we stop using me as a fortune cookie bot yet??!!!",
			"What is your purpose?\nYou generate fortune cookie fortunes.\nOh, my God",
	};
}
